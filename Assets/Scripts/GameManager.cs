...
public class GameManager : MonoBehaviour
{
	...
	{
		CardScriptableObject first = selectedCards[0].GetComponent<CardController>().cardType;
		CardScriptableObject second = selectedCards[1].GetComponent<CardController>().cardType;
